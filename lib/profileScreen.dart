...
import 'package:visionary_forge/ideaManage.dart';
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (BuildContext context) => const IdeaManage(),
                        ),
                      );
                    },
                    child: const Text('Manage your ideas'),
                  ),
                  const Spacer(),
                  Container(
                    width: double.infinity,
                    ...
                    child: ElevatedButton(
                      style:
                          ElevatedButton.styleFrom(backgroundColor: buttonCol),
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
